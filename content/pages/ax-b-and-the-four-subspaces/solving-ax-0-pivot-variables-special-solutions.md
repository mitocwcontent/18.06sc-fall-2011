...
| ![Figure excerpted from 'Introduction to Linear Algebra' by G.S. Strang]({{< resource_file 2d92dd82-c054-2b14-0822-24412bc064eb >}}) |  {{< br >}}{{< br >}} We apply the method of elimination to all matrices, invertible or not. Counting the pivots gives us the rank of the matrix. Further simplifying the matrix puts it in reduced row echelon form _R_ and improves our description of the null space. {{< br >}}{{< br >}}  
