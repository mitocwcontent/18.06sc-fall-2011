...
| ![Figure excerpted from 'Introduction to Linear Algebra' by G.S. Strang]({{< resource_file d187d604-f915-b33c-101c-76548610ff90 >}}) |  {{< br >}}{{< br >}} Linear regression is commonly used to fit a line to a collection of data. The method of least squares can be viewed as finding the projection of a vector. Linear algebra provides a powerful and efficient description of linear regression in terms of the matrix _ATA_. {{< br >}}{{< br >}}  
